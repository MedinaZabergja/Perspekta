    ...
    <div className="relative min-h-full overflow-hidden px-4 py-8 sm:px-6 sm:py-10">
      ...
      >
        <div className="flex flex-col items-center gap-8">
          ...
          >
            <h1 className="text-3xl text-[#3F473D]">Form a Balanced Perspective</h1>
          ...
          <motion.div
            className="w-full bg-white/95 backdrop-blur-sm rounded-3xl p-8 space-y-6 border border-[#CF6F85]/20 shadow-lg"
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ delay: 0.4, duration: 0.6 }}
          >
            <div className="space-y-4">
              <div className="bg-[#ffffff] rounded-2xl p-5 border border-[#CF6F85]/20 space-y-3">
                <div>
                  <p className="text-sm text-[#576154] mb-1">Original thought:</p>
                  <p className="text-[#3F473D] italic">"{thought}"</p>
                </div>
                <div className="border-t border-[#CF6F85]/20 pt-3">
                  <p className="text-sm text-[#576154] mb-2">Evidence you found:</p>
                  <ul className="space-y-1">
                    {evidence.map((item, index) => (
                      <li key={index} className="flex gap-2 text-sm text-[#3F473D]">
            ...
            <div className="space-y-3">
              <label className="block text-[#3F473D]">Your Balanced Perspective</label>
              <textarea
                value={perspective}
